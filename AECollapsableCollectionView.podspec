...
Pod::Spec.new do |s|
  ...
  s.name         = "AECollapsableCollectionView"
  s.version      = "0.0.1"
  s.summary      = "a collapsable UICollectionView work with section header."
  ...
  s.homepage     = "https://github.com/canicelebrate/AECollapsableCollectionView"
  ...
  s.source       = { :git => "https://github.com/canicelebrate/AECollapsableCollectionView.git", :tag => s.version }
